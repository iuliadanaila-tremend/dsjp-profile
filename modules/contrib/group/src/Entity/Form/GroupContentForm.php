...
class GroupContentForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    // can view in the following order: The relationship the group,
    // entity (group content), they target entity itself and finally the front
    // page. This only applies if there was no destination GET parameter
    // set in the URL.
    if ($group_content->getGroup()->access('view')) {
      $form_state->setRedirectUrl($group_content->getGroup()->toUrl());
    }
    elseif ($group_content->access('view')) {
