 ...
 */
final class LanguageSelectionPageSubscriber implements EventSubscriberInterface {
  ...
  private function getLanguage() {
    ...
    $methods = $this->configFactory->get('language.types')->get('negotiation.' . LanguageInterface::TYPE_INTERFACE . '.enabled') ?: [];
