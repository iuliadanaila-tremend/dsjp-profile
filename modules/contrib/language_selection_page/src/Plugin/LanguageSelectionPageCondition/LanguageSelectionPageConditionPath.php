...
final class LanguageSelectionPageConditionPath extends LanguageSelectionPageConditionBase implements LanguageSelectionPageConditionInterface {
  ...
  public function evaluate() {
    ...
    if ($configuration['path'] === $system_site->get('page.front')) {
      ...
      $this->messenger->addError($this->t('The Language Selection Page cannot be used as frontpage. To avoid infinite redirect loops, the language selection page path has been reset to <strong>/language_selection_page</strong> and the default frontpage setting has been reset to <strong>/node</strong>.'));
