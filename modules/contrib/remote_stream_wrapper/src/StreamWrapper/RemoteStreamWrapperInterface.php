...
interface RemoteStreamWrapperInterface extends StreamWrapperInterface {
  ...
  /**
   * Prevents the image style generation for the images requested through
   * remove stream wrappers.
   *
   * Remote stream wrappers are the ones that implement this interface.
   *
   * @return bool
   */
