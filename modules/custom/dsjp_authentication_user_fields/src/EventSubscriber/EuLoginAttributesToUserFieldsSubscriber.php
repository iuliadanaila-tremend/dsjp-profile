...
namespace Drupal\dsjp_authentication_user_fields\EventSubscriber;

use Drupal\cas\Event\CasPostLoginEvent;
use Drupal\cas\Event\CasPreRegisterEvent;
use Drupal\cas\Service\CasHelper;
use Drupal\dsjp_authentication_user_fields\EuLoginAttributesHelper;
...
class EuLoginAttributesToUserFieldsSubscriber implements EventSubscriberInterface {
  ...
  public function updateUserData(CasPostLoginEvent $event): void {
    $properties = EuLoginAttributesHelper::convertEuLoginAttributesToFieldValues($event->getCasPropertyBag()
      ->getAttributes());
